...
export type { ScholarshipDetailTab } from './ScholarshipDetailSegmentedTabs';
export { ScholarshipEligibilityChecklist, type ScholarshipEligibilityChecklistProps } from './ScholarshipEligibilityChecklist';
